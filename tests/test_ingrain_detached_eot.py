...
def _ingrain(state, self_state="known_active", opponent_state="known_inactive"):
    ...
    states={side:{family:{"state":"known_inactive"} for family in ("aqua_ring","ingrain","leech_seed")} for side in ("self","opponent")}; states["self"]["ingrain"]={"state":self_state}; states["opponent"]["ingrain"]={"state":opponent_state}
