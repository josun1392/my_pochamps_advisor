...
def _inputs(*, current_types: object = None):
    snapshot = _snapshot(current_types=current_types)
    damage = build_snapshot_damage_input(snapshot, candidate_slot_index=0, candidate_move_id="flamethrower", selectable_moves=("flamethrower",), move_metadata={"category": "special", "power": 90, "type": "fire"})
