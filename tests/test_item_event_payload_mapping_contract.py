...
def test_main_window_advice_start_passes_limited_context_gate_to_battle_input(
    ...
    def fail_after_capturing_battle_input(
        *,
        ...
        include_current_condition_confirmations: bool,
            ...
            include_current_field_state_confirmation: bool,
                include_current_final_stat_confirmations: bool,
                    include_current_hp_confirmations: bool,
                    include_current_battle_format_confirmation: bool,
                    include_observed_previous_damage_confirmation: bool,
    ) -> dict[str, Any]:
        ...
        captured["include_current_field_state_confirmation"] = include_current_field_state_confirmation
        captured["include_current_final_stat_confirmations"] = include_current_final_stat_confirmations
        captured["include_current_hp_confirmations"] = include_current_hp_confirmations
        captured["include_current_battle_format_confirmation"] = include_current_battle_format_confirmation
        captured["include_observed_previous_damage_confirmation"] = include_observed_previous_damage_confirmation
    ...
    assert captured["include_current_field_state_confirmation"] is limited_context_enabled
    assert captured["include_current_final_stat_confirmations"] is limited_context_enabled
    assert captured["include_current_hp_confirmations"] is limited_context_enabled
    assert captured["include_current_battle_format_confirmation"] is limited_context_enabled
    assert captured["include_observed_previous_damage_confirmation"] is limited_context_enabled
