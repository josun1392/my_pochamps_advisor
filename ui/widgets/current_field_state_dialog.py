...
class CurrentFieldStateDialog(QDialog):
    def __init__(self, *, current_field: dict[str, Any] | None = None, parent: QWidget | None = None) -> None:
        ...
        form = QFormLayout(); self.weather = self._combo(("none", "sun", "rain", "sandstorm", "snow")); self.terrain = self._combo(("none", "electric", "grassy", "psychic", "misty")); form.addRow("Weather", self.weather); form.addRow("Terrain", self.terrain); layout.addLayout(form)
