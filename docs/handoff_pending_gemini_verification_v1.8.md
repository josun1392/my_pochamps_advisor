...
- T2 should review whether the payload should avoid conflicting no-item assumption-profile wording when an applied Light Ball item effect is present, while preserving raw damage / roll / `ko_context` boundaries.
