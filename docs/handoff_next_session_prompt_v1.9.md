...
```text
T3, continue after v7.13 Controlled UI Gemini Smoke.
...
- Recommended next milestone:
  ...
  - Alternative: v7.14 Turn Order UI Integration Closure
- Reason:
