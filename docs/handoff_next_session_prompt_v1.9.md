...
```text
T3, continue after v8.2 Opponent Move Context Helper.
...
- Recommended next milestone:
  ...
  - Alternative: v8.3 Opponent Move Source Extraction Design
- Reason:
  ...
  - Next can connect helper output to the advice payload through an explicit/default-off adapter, or first design source extraction if the UI/cache source path needs more shaping.
