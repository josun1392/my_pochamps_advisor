...
```text
T3, continue after v9.3 Opponent Move UI Copy / Tooltip Polish.
...
- Reason:
  ...
  - v9.4 should close the opponent move UI/source integration phase before any actual Gemini smoke or next battle-state context phase.
