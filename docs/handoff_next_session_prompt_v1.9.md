...
```text
T3, continue after v12.17 Limited Context Copy Update for Field State.
...
- Current recommended next milestone is v12.18 Field State UI End-to-End Offline Smoke.
