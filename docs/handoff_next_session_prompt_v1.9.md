...
```text
T3, continue after v8.5 Opponent Move Offline Advice Fixture.
...
- Reason:
  ...
  - Next should design a controlled Gemini smoke before any provider call.
