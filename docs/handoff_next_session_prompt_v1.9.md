...
```text
T3, continue after v10.3 Battle State Context Payload Adapter.
...
- Recommended next milestone:
  ...
  - Alternative: v10.4 Battle State Source Inventory
- Reason:
  ...
  - v10.4 should add prompt guard wording before any UI/source integration or actual Gemini smoke. Do not add UI/source integration, provider call, hidden-state inference, or full Turn Engine behavior unless explicitly scoped.
