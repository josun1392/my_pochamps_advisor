...
```text
T3, continue after v9.2 Opponent Move UI Integration Offline E2E.
...
- Reason:
  ...
  - v9.3 should polish the existing checkbox label/tooltip/status copy so it accurately describes the combined limited context behavior.
