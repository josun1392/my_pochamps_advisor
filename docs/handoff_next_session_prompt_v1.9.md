...
```text
T3, continue after v8.6 Controlled Gemini Smoke Design.
...
- Recommended next milestone:
  ...
  - Alternative: v8.7 Prompt Wording Polish
  - Alternative: v8.7 Opponent Move UI/Source Integration Design
- Reason:
  ...
  - v8.7 may run at most one actual Gemini call only if T1 explicitly approves the one-call smoke.
