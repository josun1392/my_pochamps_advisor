...
```text
T3, continue after v10.2 Battle State Context Helper.
...
- Recommended next milestone:
  ...
  - Alternative: v10.3 Battle State Source Inventory
- Reason:
  ...
  - v10.3 may add an explicit/default-off payload adapter only if T1/T2 approve that scope; do not add prompt guard, UI/source integration, provider call, hidden-state inference, or full Turn Engine behavior unless explicitly scoped.
