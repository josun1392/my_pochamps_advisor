...
```text
T3, continue after v10.1 Battle State Context Payload Contract.
...
- Recommended next milestone:
  ...
  - Alternative: v10.2 Battle State Context Source Inventory
...
- Reason:
  ...
  - v10.2 may implement a standalone helper only if T1/T2 approve that scope; do not add payload adapter, prompt guard, UI/source integration, provider call, hidden-state inference, or full Turn Engine behavior.
