...
```text
T3, continue after v10.0 Battle State Context Design.
...
- Recommended next milestone:
  ...
  - Alternative: v10.1 Battle State Context Source Inventory
...
- Reason:
  ...
  - v10.0 should design a safe `battle_state_context` contract before implementation. Focus on known HP/state fields, field state, boosts, weather, terrain, screens, hazards, room effects, and explicit unknown/unsupported boundaries.
  ...
  - Do not implement runtime battle_state_context extraction, payload adapter, prompt guard, resolved turn order, speed tie resolver, RNG resolver, item consumption, HP update, exact trigger resolution, opponent set inference, hidden moveset inference, selected opponent move inference, species/common set/meta-based move generation, EV/IV/nature inference, hidden item inference, weather/terrain/boost inference, status inference, hazards/screens inference, or damage reverse inference in v10.1 unless T1/T2 explicitly change scope.
