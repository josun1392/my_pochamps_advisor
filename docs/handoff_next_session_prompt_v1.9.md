...
```text
T3, continue after v7.16 Controlled UI Gemini Smoke Retry.
...
- Recommended next milestone:
  ...
  - Alternative: v7.17 Prompt Wording Polish
- Reason:
  ...
  - Next should close the turn-order UI integration phase or do light wording polish if desired.
  ...
  - Do not implement resolved turn order, speed tie resolver, RNG resolver, item consumption, HP update, exact trigger resolution, or opponent set inference in v7.17.
