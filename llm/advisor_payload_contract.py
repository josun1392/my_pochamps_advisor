...
ADVISOR_KNOWN_LIMITATIONS = [
    ...
    "Priority, Choice Scarf speed, Tailwind, Trick Room, paralysis, Speed stages, selected ability speed effects, speed order, and Turn Engine state remain unknown.",
