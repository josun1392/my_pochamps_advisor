...
_KINDS={"direct_move_damage_observed","used_move_observed","exact_hp_transition_observed","pokemon_switch_observed","pokemon_faint_observed","condition_applied_observed"}
