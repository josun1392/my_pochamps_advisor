...
def build_predictive_normal_formula_interval(*, branch_state: Mapping[str, Any], decision_owner: Mapping[str, Any], target_owner: Mapping[str, Any], snapshot_damage_input: Mapping[str, Any], stat_provenance: Mapping[str, Any], trusted_level: int | None, is_critical: bool = False, source_runtime_fingerprint: str | None = None) -> dict[str, Any]:
    ...
    if not isinstance(is_critical,bool): return _r("rejected","invalid_critical_damage_scope")
    ...
    native=evaluate_direct_damage_mechanics(deepcopy(dict(snapshot_damage_input)),stat_provenance=deepcopy(dict(stat_provenance)),trusted_level=trusted_level,is_critical=is_critical)
