...
from llm.advisor_guaranteed_fact_comparison import guaranteed_facts_from_exact_outcome, guaranteed_facts_from_water_gun_interval, rank_guaranteed_candidates

def run_detached_strategy_orchestration(*,decision_state:Mapping[str,Any],decision_owner:Mapping[str,Any],selection_snapshot:Mapping[str,Any],execution_bundle:Mapping[str,Any],predictive_attacks:Mapping[str,Mapping[str,Any]]|None=None,water_gun_inputs:Mapping[str,Any]|None=None)->dict[str,Any]:
 ...
 evidence=[]; facts=[]; attacks=predictive_attacks or {}; water=water_gun_inputs or {}
