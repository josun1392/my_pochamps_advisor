...
def execute_explicit_two_turn(
    *,
    ...
    first_eot = _project_bounded_eot(pre_end_of_turn=first, weather_event_target_order=turn_one.get("weather_event_target_order"), leftovers_event_target_order=turn_one.get("leftovers_event_target_order"), aqua_ring_target_order=turn_one.get("aqua_ring_target_order"), condition_event_target_order=turn_one.get("condition_event_target_order"))
    ...
    second_eot = _project_bounded_eot(pre_end_of_turn=second, weather_event_target_order=turn_two.get("weather_event_target_order"), leftovers_event_target_order=turn_two.get("leftovers_event_target_order"), aqua_ring_target_order=turn_two.get("aqua_ring_target_order"), condition_event_target_order=turn_two.get("condition_event_target_order"))
...
def _project_bounded_eot(*, pre_end_of_turn: Mapping[str, Any], weather_event_target_order: Mapping[str, Any] | None = None, leftovers_event_target_order: Mapping[str, Any] | None = None, aqua_ring_target_order: Mapping[str, Any] | None = None, condition_event_target_order: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    if weather_event_target_order is not None:
        ...
        return project_cross_owner_weather_end_of_turn(pre_end_of_turn=pre_end_of_turn, weather_event_target_order=weather_event_target_order, leftovers_event_target_order=leftovers_event_target_order, aqua_ring_target_order=aqua_ring_target_order, condition_event_target_order=condition_event_target_order)
...
def _weather_has_active_ability(state: Mapping[str, Any], ability: str) -> bool:
    """Dispatch an approved weather recovery only when its exact ability is present."""
