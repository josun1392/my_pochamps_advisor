...
def discover_candidates(*,snapshot:Mapping[str,Any])->dict[str,Any]:
 ...
 for a in snapshot["actions"]:
  if a["selection"]=="selectable":rows.append({"schema_version":"deterministic-action-candidate-v1","candidate_id":a["action_id"],"session_id":snapshot["session_id"],"decision_owner":snapshot["decision_owner"],"source_branch_fingerprint":snapshot["decision_branch_fingerprint"],"action_type":a["action_type"],"action_authority":a["execution_authority"]})
