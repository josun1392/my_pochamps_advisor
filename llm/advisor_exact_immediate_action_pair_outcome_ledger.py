...
def _fling_berry_eaten_transition_leaf(leaf: Mapping[str, Any]) -> str | None:
    ...
    interactions = [
        value for value in (cure_interaction, type_resist_interaction, persim_interaction)
