...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    ...
    return (
        ...
        "species_stat_item_context is available, you may say Light Ball may "
        "boost Pikachu's offensive stats in the underlying calculation and "
        "that this is species-specific to Pikachu. Do not generalize Light "
        ...
        "you may say Chilan Berry may reduce damage from a Normal-type move, "
        "but this is limited context and not guaranteed survival. Do not say "
