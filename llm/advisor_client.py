...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    return (
        ...
        "items, or speed order from final stats. If item_profiles is present, "
        "distinguish unknown, none, system_default_none, and user_confirmed "
        "items. Only item effects marked as applied in "
        "damage_estimate.item_effects are included in damage numbers. If an "
        ...
        "item modifier. Choice lock, Life Orb recoil, Choice Scarf speed, "
        "Focus Sash survival, and Leftovers recovery are not connected. When discussing type matchups, "
