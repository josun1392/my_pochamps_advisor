...
def run_structured_ui_recommendation(*, selected_moves: Any, battle_input: Mapping[str, Any], move_repository: Any, species_repository: Any = None, model: str | None = None, usage_logging_enabled: bool = False, observation_snapshot: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Separate structured coexistence flow; it never falls back to legacy advice."""
    prepared = prepare_ui_recommendation_cycle(selected_moves=selected_moves, battle_input=battle_input, move_repository=move_repository, species_repository=species_repository, observation_snapshot=observation_snapshot)
