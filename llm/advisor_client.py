...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    return (
        ...
        "damage_estimate.item_effects are included in damage numbers. Choice "
        "lock, Life Orb recoil, Choice Scarf speed, Focus Sash survival, and "
        "Leftovers recovery are not connected. Opponent candidate move damage is not "
