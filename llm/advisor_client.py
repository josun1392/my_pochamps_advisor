...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    return (
        ...
        "marks it applied from a user-confirmed item; choice lock is still not "
        "modeled. If raw Speed and effective Speed disagree, explain the "
        ...
        "Choice lock, Life Orb recoil, Focus Sash survival, "
