...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    return (
        ...
        "Leftovers, or Focus Sash. Life Orb recoil and Leftovers recovery "
        "are not connected. Focus Sash survival may appear only as limited "
        ...
        "available, say may survive at 1 HP; do not say definitely survives "
        "or guarantees survival. Multi-hit moves, hazards, residual damage, "
        "weather/status chip, ability interactions, and exact turn sequencing "
        "are not modeled for Focus Sash survival_context. Do not infer Focus "
