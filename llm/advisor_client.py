...
def _build_ui_selected_prompt(battle_input: dict[str, Any]) -> str:
    return (
        ...
        "user-facing recommendation text. Do not say Loaded Dice is not "
        "modeled or Power Herb is not modeled unless the user explicitly asks "
        "about that item; do not imply blocked or future-only items are "
        "available in Champions. If an "
