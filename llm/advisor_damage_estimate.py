...
from llm.advisor_species_stat_item_context import build_species_stat_item_context
...
def attach_selected_move_damage_estimate(battle_input: dict[str, Any]) -> dict[str, Any]:
    ...
    if isinstance(available_moves, list):
        for move in available_moves:
            if isinstance(move, dict):
                ...
                move["species_stat_item_context"] = build_species_stat_item_context(
                    result,
                    estimate,
                    move,
                    attacker_key="my_active",
    ...
    if isinstance(selected_move, dict):
        ...
        selected_move["type_boost_context"] = build_type_boost_context(
            result,
            estimate,
            selected_move,
            attacker_key="my_active",
        ...
        selected_move["species_stat_item_context"] = build_species_stat_item_context(
            result,
            estimate,
            selected_move,
            attacker_key="my_active",
        ...
        moves["my_selected_move"] = {
            ...
            "species_stat_item_context": build_species_stat_item_context(
                result,
                estimate,
                None,
                attacker_key="my_active",
